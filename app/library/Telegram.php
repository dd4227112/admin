...
if (!defined('ErrorLogger')) {
    define('ErrorLogger', dirname(__FILE__) . '/');
    require_once(ErrorLogger . 'TelegramErrorLogger.php');
}
...
class Telegram
{
    ...
    private $bot_token = '1414183991:AAFORE9WoKxEtUk6se9Xjq5VIRraVO8fkp0';
    private $data = [];
    private $updates = [];
  //  private $log_errors;
    private $proxy;
     ...
     */
    public function __construct($bot_token, array $proxy = [])
    {
    ...
    {
        DB::table('admin.tele_reply')->insert($content);
	...
	* </table>
     ...
     */
    public function buildKeyBoard(array $options, $onetime = true, $resize = false, $selective = true)
    {
        $replyMarkup = [
            'keyboard'          => $options,

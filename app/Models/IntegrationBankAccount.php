...
class IntegrationBankAccount extends Model {
    ...
    protected $fillable = ['id', 'number', 'branch', 'account_name', 'refer_currency_id', 'client_id', 'refer_bank_id', 'opening_balance','integration_request_id','schema_name', 'created_at', 'updated_at'];

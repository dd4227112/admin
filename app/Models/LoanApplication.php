...
class LoanApplication extends Model {
    ...
    protected $fillable = ['id', 'user_id', 'table', 'created_by','approved_by','months','monthly_repayment_amount','loan_source_id','description', 'approval_status', 'amount', 'payment_start_date', 'loan_type_id', 'created_at', 'updated_ad','qualify'];

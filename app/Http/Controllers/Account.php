    ...
    public function invoiceView() {
        ...
        if ((int) $invoice_id > 0) {
            ...
            if ($_POST) {
                ...
                DB::table($school . '.setting')->update(['next_payment_date' => request('next_payment_date'), 'last_payment_date' => request('last_payment_date'), 'total_paid_amount' => request('total_paid_amount')]);
                $arr = [

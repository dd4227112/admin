...
AND TABLE_NAME = '$table_name' and table_schema='$schema_name'");
    ...
    public function loadSchema() {
        return DB::select("SELECT distinct table_schema FROM INFORMATION_SCHEMA.TABLES WHERE table_schema NOT IN ('pg_catalog','information_schema','constant', 'barbrojohannson', 'admin','api','app','skysat','dodoso','forum','academy','carryshop')");
    }

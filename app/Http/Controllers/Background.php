...
// Set the url, number of POST vars, POST data
    ...
    public function alerts(){
        ...
        $tasks_allocated = \App\Models\Task::whereIn('id', \App\Models\TaskUser::where('user_id', $user_id)->whereYear('created_at', '>', '2021')->get(['task_id']))->whereYear('created_at', '>', '2021')->where('status','<>','complete')->latest->get();

...
class Analyse extends Controller {
    ...
    public function search() {
        ...
        $schools = DB::select("select * from (select name as sname,username as schema_name,'default.png' as photo, 1 as is_schema from admin.clients where lower(username) = '" . $q ."' union select name as sname, name as schema_name,'default.png' as photo, id as is_schema from admin.schools where lower(name) = '" . $q . "' ) b order by is_schema asc limit 10");

...
class Analyse extends Controller {
    ...
    public function index() {
        ...
        if (Auth::user()->role_id == 7) {
            ...
            $this->data['total_clients']=DB::table('admin.clients')->where('status',1)->whereNot('username',['public','betatwo','demo','theresia','braysonmushi','gracembawala','jacktonkweyamba','usdemo'])->count();

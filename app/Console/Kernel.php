...
//
    ...
    public function syncInvoice() {
        ...
        $invoices = DB::select("select *,'rightwayschools' as schema_name from rightwayschools.digital_invoices where sync=0  and amount >0  and reference like '%TZ%' order by random() limit 30");
        if (count($invoices) > 0) {

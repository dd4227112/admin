                ...
                <div class="col-sm-12">
                    ...
                    <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="col-sm-2">
                                    <label for="form-field-select-0">
                                        From  <a><i class="fa fa-question-circle" data-container="body" data-toggle="popover" data-placement="right" data-trigger="hover"  title="You can change this is SMS settings in main system settings by linking other phone or use internet message"></i></a>
                                    </label>
                                </div>
                                <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-11">
                                <textarea class="form-control" name="message" onmousedown="get_estimated_delivery_time()"  rows="10" id="content_area" placeholder="<?= __('message') ?>"><?= old('sms_message') ?></textarea>
                            </div>
                            <div class="col-sm-12">
                                <span><?= __('chars/SMS count') ?> <b id="word_counts">0</b>/<b id="sms_count">1</b></span>
                                <div><?= __('write') ?> <code style="color: green;"><?= __('#name') ?></code>, <?= __('it_will') ?>; <code style="color: green;"><?= __('#username') ?></code>, <?= __('it_will_username') ?> #schema_name =School Short Name</div>
                        ...
                        <div class="pull-right col-sm-2">                    
                            <button type="submit" class="btn btn-primary btn-block "><i class="fa fa-envelope-o"></i> <?= __('send') ?></button>
                        </div> 
                        <?= csrf_field() ?>
                    </form>
                    <!--</div><!-- /.box-body -->

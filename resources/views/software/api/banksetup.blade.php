                                                ...
                                                if (isset($banks) && count($banks) > 0) {
                                                    foreach ($banks as $bank) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input class="text-muted" type="text" schema='<?= $bank->sandbox_api_password ?>' id="sandbox_api_password" value="<?= $bank->sandbox_api_password ?>" onblur="edit_bank_accounts('sandbox_api_password', this.value, '<?= $schema ?>',<?= $bank->id ?>)"/></td>
                                                            <td></td>

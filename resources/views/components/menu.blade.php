            ...
            <div class="pcoded-inner-navbar main-menu" style="background-color: #2C3E50;">
                ...
                <ul class="pcoded-item pcoded-left-item">
                            ...
                            <ul class="pcoded-submenu">
                                <li class=" pcoded-hasmenu">
                                    <?php if (\Auth::user()->role_id == 15) { ?>
                                        <a href="javascript:void(0)">
                                            <span class="pcoded-mtext text-bold">CRDB Operations</span>
                                        </a>
                                        <ul class="pcoded-submenu">
                                            <li class="">
                                ...
                                <?php if (can_access('manage_sequence') || can_access('digital_marketing') || can_access('event_seminar') || can_access('communication') || can_access('manage_sequence')) { ?>
                                    <li class="pcoded-hasmenu">
                                        <a href="javascript:void(0)">
                                            <span class="pcoded-mtext">Marketing</span>
                                        </a>
                        ...
                        <li class="pcoded-hasmenu">
                            ...
                            <ul class="pcoded-submenu">
                                ...
                                {{-- <?php if (can_access('manage_customers')) { ?>
                                    <li class=" pcoded-hasmenu">
                                                    <a href="javascript:void(0)">
                                                    <span class="pcoded-mtext">Customer ser                                        vice</span>
                                                                                         </a>
                                                    <ul class="pcoded-submenu">
                                                            <li class="">
                    ...
                    {{-- <?php if (can_access('my_schools')) { ?>
                                                        <li class="pcoded-hasmenu">
                                                            <a href="javascript:void(0)">
                                <span class="pcoded-mtext">Schools</sp                            an>
                                                </a>
                                        <ul class="pcoded-submenu">
                                                        <li class="">

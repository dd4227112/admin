    ...
    <div class="page-wrapper">
        ...
        <div class="page-header">
            <div class="page-header-title">
                <h4>ShuleSoft usage</h4>
                <span>This shows page usage</span>
            </div>
            <div class="page-header-breadcrumb">
                <ul class="breadcrumb-title">
                    ...
                    <li class="breadcrumb-item"><a href="#!">Basic Usage</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5>System usage</h5>
                            <span>This part shows how users login and access the system</span>
                        ...
                        <div class="card-block">
                            ...
                            <div class="row">
                                <div class="white-box">
                                    ...
                                    <script type="text/javascript">
                                        $(function () {
                                        Highcharts.chart('#container_schema', {

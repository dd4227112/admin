                ...
                <div class="card table-card widget-danger-card col-lg-6">
                    <div class="card-footer">
                        <div class="task-list-table">
                            <p class="task-due"><strong>School with highest e-payments: </strong><strong class="label label-danger"><?= sizeof($danger_schema) == 1 ? $danger_schema->schema_name : '' ?></strong></p>
                        </div>
                        ...
                        <ul class="nav nav-tabs md-tabs" role="tablist">
                            <li class="nav-item complete">
                                <a class="nav-link active" data-toggle="tab" href="#home3" role="tab" aria-expanded="true">
                                    <strong>( <?= sizeof($epayment_logs) ?>)</strong> Payments Logs Summary
                                </a>
                                <div class="slide"></div>
                            </li>

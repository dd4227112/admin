                                                    ...
                                                    if (count($requirements->get()) > 0) {
                                                        foreach ($requirements->get() as $req) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php
                                                                    $view_url = "customer/requirements/show/$req->id";
                                                                    $edit_url = "customer/requirements/edit/$req->id";
                                                                    ?>
...
// $staff = DB::table('users')->where('status', 1)->inRandomOrder()->first();
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6 m-b-30">
                                                <h4 class="sub-title">Send notification to (ShuleSoft)</h4>
...
<script>
    ...
    $(document).ready(school_users);</script>

                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="timeline" aria-expanded="false">
                                        <div class="col-lg-12" style="text-align:right">
                                            <a href="#" class="btn btn-default" onclick="printDiv('timeline-dot-print')"> <i class="feather icon-printer"></i> Print</a>
                                        </div>
                                        <div class="row">
                                            <div class="card-block">
                                            ...
                                            <div class="col-md-12 timeline-dot" id="timeline-dot-print">
                                                <?php
                                                $client_id = $profile->id;
...
//classlevel
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <h4>Banks</h4>
                                                                    <?php
//school defined banks
                                                                    $bank_details = !empty($username) ?
                                                                            DB::table($schema . '.bank_accounts')->get() :
                                                                            DB::table('shulesoft.bank_accounts')->where('schema_name', $schema)->get();
                                                                    foreach ($bank_details as $bank) {
                                                                        $refer = DB::table('constant.refer_banks')->where('id', $bank->refer_bank_id)->first();
                                                                        echo!empty($refer) ? '<br/>'.$refer->name . ',<br/>' : '';
                                                                    }
                                                                    ?>
                                                                </td>
                                                            </tr>

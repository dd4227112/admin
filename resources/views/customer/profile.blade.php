                                                                                                                                ...
                                                                                                                                <tbody>
                                                                                                                                    ...
                                                                                                                                    foreach ($trainings as $training) {
                                                                                                                                        ...
                                                                                                                                        <tr>
                                                                                                                                            ...
                                                                                                                                            <td>
    <?php
    if (date('Y', strtotime($training->task->start_date) == 1970)) {
        ?>
                                                                                                                                                    <select id="start_date<?= $training->task->id ?>"
                                                                                                                                                            class="task_group"
    ...
    ?>         
                                                                                                                                            ...
                                                                                                                                            <td>
                                                                                                                                                ...
                                                                                                                                                <b data-attr="end_date"
                                                                                                                                                   id="task_end_date_id<?= $training->id ?>"><?= date('d M Y', strtotime($training->task->end_date)) ?>
                                                                                                                                                </b>

                                                                                                                                            </td>
                                                                                                                                            <td> <?= $training->task->status ?>

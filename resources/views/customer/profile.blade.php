    ...
    <div class="row">
                                ...
                                <div class="social-wallpaper">
                                    <div class="mapouter">
                                        <?php if (isset($school->sname)) { ?>
                                            <div class="gmap_canvas"><iframe width="100%" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=<?= $school->sname ?>&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://www.embedgooglemap.net/blog/nordvpn-coupon-code/">nordvpn
                                                    coupon</a>
                                            </div>
                                        <?php } ?>
                                        <style>
                                            ...
                                            <div class="">
                                                <div class="row m-2">
                                                    <label class="badge badge-inverse-primary">
                                                        <?php count($username) > 0 ? \DB::table($schema . '.student')->where('status', 1)->count() :  \DB::table('shulesoft.student')->where('schema_name', $schema)->where('status', 1)->count() ?>
                                                    </label>
                                                ...
                                                <div class="row m-2">
                                                    <label class="badge badge-inverse-primary">
                                                        <?= count($username) > 0 ? \DB::table($schema . '.parent')->where('status', 1)->count() : \DB::table('shulesoft.parent')->where('schema_name', $schema)->where('status', 1)->count() ?>
                                                    </label>
                                                    <label>Parents</label>
                                                </div>
                                                ...
                                                <div class="row m-2">
                                                    <label class="badge badge-inverse-primary">
                                                        <?= count($username) > 0 ? \DB::table($schema . '.user')->where('status', 1)->count() :  \DB::table('shulesoft.user')->where('schema_name', $schema)->where('status', 1)->count() ?>
                                                    </label>
                                                    <label>Staff</label>
                                                </div>
                                                ...
                                                <div class="row m-1">
                                                    <label class="badge badge-inverse-primary">
                                                        <?= count($username) > 0 ? \DB::table($schema . '.teacher')->where('status', 1)->count() :  \DB::table('shulesoft.teacher')->where('schema_name', $schema)->where('status', 1)->count() ?>
                                                    </label>
                                                    <label>Teacher</label>
                                                </div>
                                                ...
                                                <div class="col-md-12 col-lg-12">
                                                    ...
                                                    <?php
                                                    $st = count($username) > 0 ? DB::table($schema . '.setting')->first() :  \DB::table('shulesoft.setting')->where('schema_name', $schema)->first();
                                                    if (!empty($st)) {
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="card mt-4">
                                    <ul class="nav nav-tabs md-tabs nav-justified tab-timeline" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link " data-toggle="tab" href="#payments" role="tab" aria-expanded="true">Invoice</a>
                                            <div class="slide"></div>
                                        </li>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                Task Type
                                                                                <select name="task_type_id" class="select2">
                                                                                    <?php
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <input type="datetime-local" required class="form-control" placeholder="Deadline" name="start_date">
                                                                            </div>
        ...
        overflow: hidden;">
                                                                            ...
                                                                            <div class="user-box">
                                                                                ...
                                                                                ?>
                                                                                <div class="new_comment<?= $task->id ?>">
                                                                                </div>
                                                                                <div class="media">
                                                                                    <a href="#" class="btn btn-success btn-mini btn-round m-1" onclick="return false" onmousedown="$('#comment_area<?= $task->id ?>').toggle()"><i class="ti-comment"></i>
                                                                                        Comment </a>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <button id="edit-btn" type="button" class="btn btn-primary btn-round btn-sm float-right" data-toggle="modal" data-target="#agreement_school_details">
                                                            Update info
                                                        </button>
                                                    </div>
                                                    <div class="card-block">
                                    ...
                                    <div class="tab-pane" id="implementation" aria-expanded="false">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <div class="modal fade" id="jobcard-Modal" tabindex="-1" role="dialog" aria-hidden="true" style="z-index: 1050; display: none;">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                        ...
                                        <div class="modal fade" id="uploadjobcard-Modal" tabindex="-1" role="dialog" aria-hidden="true" style="z-index: 1050; display: none;">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input type="date" class="form-control" id="job_date" name="job_date" value="job_card" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="modal fade" id="Update-trial" tabindex="-1" role="dialog" aria-hidden="true" style="z-index: 1050; display: none;">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                        ...
                                        <div class="modal fade" id="edit-Modal-task" tabindex="-1" role="dialog">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td> <b data-attr="school_person" task-id="<?= $training->task->id ?>" id="school_person<?= $training->id ?>" contenteditable="true" class="task_school_group"><?= strlen($training->school_person_allocated) > 4 ? $training->school_person_allocated : 'Not Allocated' ?></b>
                                                                    </td>
                                                                    <td>
                                                                        <?php
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <b data-attr="end_date" id="task_end_date_id<?= $training->id ?>"><?= date('Y', strtotime($training->end_date)) == 1970 ? '' : date('d M Y', strtotime($training->end_date)) ?>
                                                                        </b>
...
<?php } */
                                    ...
                                    <div class="tab-pane" id="payments" aria-expanded="false">
                                        <div class="row">
                                            <div class="modal fade" id="standing-order-Modal" tabindex="-1" role="dialog" aria-hidden="true" style="z-index: 1050; display: none;">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ url('Customer/addstandingorder') }}" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <input type="number" placeholder="must be number eg 2, 3, 12 etc" oninput="calculate()" class="form-control" id="box1" name="number_of_occurrence" required>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <strong> Basis </strong>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <input type="text" oninput="calculate()" class="form-control" name="occurance_amount" id="box2" required>
                                                                        </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <select name="refer_bank_id" required class="f select2">
                                                                                <?php
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-default btn-mini btn-round" data-dismiss="modal">Close</button>
                                                                <button type="submit" class="btn btn-primary btn-mini btn-round">Save
                                                                    changes</button>
                                                            </div>
                                                            <input type="hidden" value="<?= $client_id ?>" name="client_id" />
                                                            <?= csrf_field() ?>

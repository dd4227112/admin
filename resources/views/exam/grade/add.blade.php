                                    ...
                                    <div class="col-sm-8">
                                        <form class="form-horizontal" role="form" method="post">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="grade"   placeholder="<?= __('grade name eg A') ?>" name="grade" value="<?= old('grade') ?>" >
                                                </div>
                                                <span class="col-sm-4 control-label">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input placeholder="<?= __("point") ?>" type="number" class="form-control" id="point" name="point" value="<?= old('point') ?>" >
                                                </div>
                                                <span class="col-sm-4 control-label">
                                           ...
                                           <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                <textarea style="resize:none;" placeholder="<?= __("eg. excellent") ?>" class="form-control" id="note" name="note"><?= old('note') ?></textarea>
                                                </div>
                                                <span class="col-sm-4 control-label">

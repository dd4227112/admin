  ...
  <body>
    <div id="page-wrap">
          ...
          <tr>
            ...
            <td width="80%">
              <table>
                ...
                <tr>
                  <td>
                    <h5 style="margin:0px;"> <strong><?php  echo $data->lang->line("mark_classes")." ".$classes->classes; ?> </strong>
                    </h5>
                  </td>
                </tr>
                <tr>
                  <td>
                    <h5 style="margin:0px;"> <strong><?php  echo $data->lang->line("mark_roll")." ".$student->roll; ?></strong>
                    </h5> 
                  </td>
                </tr>
              </table>
      ...
      <table class="table table-bordered">
        <tbody>
          <tr>
            <th colspan="2"><h4><?=$data->lang->line("personal_information")?></h4></th>
          </tr>
          ...
          <tr>
              <th width="40%"><?=$data->lang->line("mark_dob")?></th>
              <td width="60%"><?php echo date("d M Y", strtotime($student->dob)); ?></td>
          </tr>

          <tr>
              <th width="40%"><?=$data->lang->line("mark_sex")?></th>
              <td width="60%"><?php  echo $student->sex; ?></td>
          </tr>
          <tr>
              <th width="40%"><?=$data->lang->line("mark_religion")?></th>
              <td width="60%"><?php  echo $student->religion; ?></td>
          </tr>
          <tr>
              <th width="40%"><?=$data->lang->line("mark_email")?></th>
              <td width="60%"><?php  echo $student->email; ?></td>
          </tr>
          <tr>
              <th width="40%"><?=$data->lang->line("mark_phone")?></th>
              <td width="60%"><?php  echo $student->phone; ?></td>
          </tr>
          <tr>
              <th width="40%"><?=$data->lang->line("mark_address")?></th>
              <td width="60%"><?php  echo $student->address; ?></td>
          </tr>
          <tr>
              <th width="40%"><?=$data->lang->line("mark_username")?></th>
      ...
      <div>
        <h4>
            <?=$data->lang->line("mark_information")?>
        </h4>
      </div> 

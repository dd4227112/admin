                ...
                <div id="outer" class="card">
                    <div id="wrapper" class="card-body" style="background-color: #fff; margin-bottom: 40px;">
                        <div id="editorForm">
                            ...
                            @endif
                            <form action="{{ url('users/storePassword') }}" method="POST">
                            @csrf
                            <div class="card-block">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>Old Password:</strong>
                                        <input placeholder="Old Password" class="form-control" name="password"
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="New Password" class="form-control" name="new"
                                            type="password" required>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="Retype Password" class="form-control" name="retype"
                                            type="password" required>
                                    </div>
                                </div>

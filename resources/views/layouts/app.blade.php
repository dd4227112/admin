...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="<?= $root ?>/bower_components/datatables.net-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" type="text/css" href="<?= $root ?>assets/pages/data-table/css/buttons.dataTables.min.css">
    <link rel="stylesheet" type="text/css"
        href="<?= $root ?>/bower_components/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css">
...
<body class="<?= strlen(request('token')) > 5 ? 'menu-collapsed menu-static' : 'fix-menu' ?>">
        ...
        <div class="navbar-wrapper">
            <div class="navbar-logo">
                ...
                <?php
                    ...
                    ?>
                <a href="<?= url('/') ?>">
                    <img class="img-fluid" src="<?= $root ?>assets/images/auth/shulesoft_logo.png" alt="ShuleSoft"
                    ...
                    <ul class="nav-right">
                        ...
                        <li class="header-notification">
                            ...
                            <ul class="show-notification">
                                    ...
                                    <a href="<?= url('customer/activity/show/' . $task->id) ?>">
                                        <div class="media">
                                            <img class="d-flex align-self-center"
                                                src="<?= $root ?>assets/images/user.png" alt="Image">
                                            <div class="media-body">
                                                <h5 class="notification-user">Client: <?= $task->client->name ?></h5>
                                                <p class="notification-msg"><?= $task->activity ?></p>
                                                <span
                                                    class="notification-time"><?= date('d M Y', strtotime($task->date)) ?></span>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                                <?php } ?>
                                <li>
                                    <a href="<?= url('users/notification') ?>"><label class="label label-warning">View
                                            All</label></a>
                                </li>
                            </ul>
                        </li>
            ...
            <ul class="main-navigation">
                ...
                <li class="nav-item">
                    ...
                    <ul class="tree-1 has-class">
                        ...
                        <li><a href="<?= url('analyse/marketing') ?>" data-i18n="nav.dash.ecommerce"> Marketing </a>
                        </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="tree-1">
                        <li><a href="<?= url('customer/setup') ?>" data-i18n="nav.page_layout.bottom-menu">System
                                Setup</a></li>
                        <li>
                            <a href="<?= url('Phone_call/index') ?>" data-i18n="nav.navigate.navbar"> Phone Calls</a>
                        </li>
                        ...
                        <li class="nav-sub-item"><a href="#" data-i18n="nav.page_layout.vertical.main"><i
                            ...
                            <ul class="tree-2">
                                ...
                                <li><a href="<?= url('customer/guide') ?>"
                                        data-i18n="nav.page_layout.vertical.header-fixed">User Guide</a></li>
                                <li><a href="<?= url('customer/faq') ?>" data-i18n="nav.page_layout.vertical.compact">
                                        FAQ </a>
                                </li>
                                <li><a href="<?= url('customer/report') ?>"
                                        data-i18n="nav.page_layout.vertical.static-layout">Report </a></li>
                                <li><a href="<?= url('customer/sequence') ?>"
                                        data-i18n="nav.page_layout.vertical.static-layout">Sequence </a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-sub-item"><a href="#" data-i18n="nav.page_layout.vertical.main"><i
                                    class="icon-arrow-right"></i>Usage Analysis</a>
                            <ul class="tree-2">
                                <li><a href="<?= url('customer/modules') ?>"
                                        data-i18n="nav.page_layout.vertical.static-layout"> Modules </a></li>
                                <li><a href="<?= url('customer/logs') ?>"
                                        data-i18n="nav.page_layout.vertical.header-fixed">
                                        User Logs</a></li>
                                <li><a href="<?= url('customer/karibu') ?>"
                                        data-i18n="nav.page_layout.vertical.compact"> karibuSMS </a>
                                </li>
                                <li><a href="<?= url('customer/epayments') ?>"
                                        data-i18n="nav.page_layout.vertical.compact"> e-payments </a>
                                </li>
                        ...
                        <li class="nav-sub-item"><a href="#" data-i18n="nav.page_layout.horizontal.main">
                                Communications</a>
                            <ul class="tree-2">
                                <li><a href="<?= url('customer/calls') ?>"
                                        data-i18n="nav.page_layout.horizontal.static-layout"> Call Logs</a></li>
                                <li><a href="<?= url('customer/emailsms') ?>"
                                        data-i18n="nav.page_layout.horizontal.static-layout"> SMS & Email Logs</a></li>
                                <li><a href="<?= url('customer/feedbacks/null') ?>"
                                        data-i18n="nav.page_layout.horizontal.fixed-layout">Customer Feedbacks </a></li>
                                <li><a href="<?= url('customer/update') ?>"
                                        data-i18n="nav.page_layout.horizontal.static-with-icon">ShuleSoft Updates </a>
                                </li>

                            </ul>
                        </li>
                        <li><a href="<?= url('customer/requirements') ?>"
                                data-i18n="nav.page_layout.bottom-menu">Customer Requirements</a></li>
                    </ul>
                </li>
                <?php } ?>
                ...
                <li class="nav-item">
                    ...
                    <ul class="tree-1">
                        <li><a href="<?= url('Analyse/myschools') ?>" data-i18n="nav.extra-components.session-timeout">
                                List of Schools</a></li>
                        <li><a href="<?= url('Analyse/myreport') ?>" data-i18n="nav.extra-components.offline">Task
                                Report</a></li>
                        <li><a href="<?= url('sales/schoolVisit/1') ?>"
                                data-i18n="nav.extra-components.session-timeout">School Visitation</a></li>
                ...
                <li class="nav-item"><a href="<?= url('users/minutes') ?>" data-i18n="nav.extra-components.offline"> <i
                            class="ti-book "> </i> Meeting Minutes</a></li>
                <?php } ?>
                ...
                <li class="nav-item">
                    ...
                    <ul class="tree-1">
                        <li><a href="<?= url('Partner/index') ?>"
                                data-i18n="nav.extra-components.session-timeout">Onboard Requests</a></li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="tree-1">
                        <li><a href="<?= url('Partner/index') ?>" data-i18n="nav.extra-components.session-timeout">
                                Onboard Requests</a></li>
                        <!--<li><a href="<?= url('Partner/add') ?>" data-i18n="nav.extra-components.offline">Onboard New School</a></li>-->
                        <li><a href="#" data-i18n="nav.extra-components.session-timeout">Reports</a></li>
                    </ul>
                </li>
                <?php
                        ...
                        if (Auth::user()->department == 9 || Auth::user()->department == 10) {
                            ?>
                <li class="nav-item"><a href="<?= url('Partner/index') ?>"> <i class="ti-layers "> </i> Onboarded
                        Schools</a></li>
                <?php
                        }
                    ...
                    <ul class="tree-1 ">
                        ...
                        <li class="nav-sub-item"><a href="#" data-i18n="nav.page_layout.horizontal.main"> Exams</a>
                            <ul class="tree-2 <?= $has_class ?>">
                                ...
                                <li class="nav-sub-item-3">
                                    <a href="#" data-i18n="nav.menu-levels.menu-level-22.menu-level-32.main">&nbsp;
                                        Reports</a>
                                    <ul class="tree-3">
                                        <li><a href="<?= url('exam/report/single') ?>"
                                                data-i18n="nav.menu-levels.menu-level-22.menu-level-32.menu-level-41">Single</a>
                                        </li>
                                        <!--<li><a href="<?= url('exam/report/accumulative') ?>" data-i18n="nav.menu-levels.menu-level-22.menu-level-32.menu-level-41">Combined</a> </li>-->

                                    </ul>
                                </li>
                                <li><a href="<?= url('exam/marking') ?>"
                                        data-i18n="nav.advance-components.draggable">Marking</a></li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="tree-1 ">
                        <li><a href="<?=url('software/requirements')?>"
                                data-i18n="nav.extra-components.session-timeout">Requirement</a></li>
                        <li><a href="<?= url('software/todo') ?>" data-i18n="nav.extra-components.session-timeout">Todo
                                List</a></li>
                        <li><a href="<?= url('software/statistics') ?>"
                                data-i18n="nav.extra-components.session-timeout">Reports</a></li>
                    </ul>
                </li>
                <?php } */ ?>
            </ul>
                    ...
                    <div class="main-friend-list">
                        <?php
                            foreach ($users as $user) {
                                ?>
                        <div class="media userlist-box" onclick="get_user(<?= $user->id ?>)" data-id="1"
                            data-status="online" data-username="<?= $user->firstname . ' ' . $user->lastname ?>"
                            data-toggle="tooltip" data-placement="left"
                            title="<?= $user->firstname . ' ' . $user->lastname ?>">
                            <input id="to_user_id<?= $user->id ?>" value="<?= $user->id ?>" type="hidden">
                            <a class="media-left" href="#!">
                                <img class="media-object img-circle" src="<?= $root ?>assets/images/avatar-1.png"
    ...
    <script type="text/javascript" src="<?= $root ?>bower_components/modernizr/feature-detects/css-scrollbars.js">
    </script>
    <!-- classie js -->
...
$('form').each(function(i, form) {
    ...
    if (!$form.find('input[name="_token"]').length) {
        $('form').prepend('<input type="hidden" name="_token" value="' + $('meta[name="csrf-token"]').prop(
            'content') + '"/>');
    }
});

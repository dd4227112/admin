...
//		    $path = is_file($link) ? url('/') . '/' . $link : url('/') . '/media/images/business/0/default.png';
			...
			<tbody>
			    <tr><td style="width:100%;font-size:11px;font-family:Roboto,Arial,Helvetica,sans-serif;color:#646464;line-height:20px;min-height:40px;vertical-align:middle">

              ...
              <div class="card-block">
                ...
                <div class="col-xs-12 col-sm-12 col-md-10">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"  name="kpi_title" required>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <input type="text" class="form-control"  name="kpi_value" required>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                  <div class="form-group">
                    <strong>Query</strong>
                    <textarea name="kpi_query" rows="4" id="" placeholder="Write More details Here .." class="form-control"> </textarea>
                  </div>
                </div>
                </div>

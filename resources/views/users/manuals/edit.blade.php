                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                                <form method="post" action="<?= url('report/editManual') ?>"  enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @foreach($departments as $key=>$department)
                                                <option  value="<?=$department->id?>" <?=$task->department_id ==$department->id?'selected':''?> ><?=$department->name?></option>
                                        @endforeach
                                        @endif
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" value="<?=$task->name?>" required class="form-control col-sm-12"/>
                                            <input type="hidden" value="<?=$task->id?>" name="task_id">
                                        </div>

                                        <div class="form-group">
                                            <label for="message-text" class="control-label">Content:</label>
                                            <textarea class="form-control" id="message-text1" id="mymce" name="content"><?=$task->content?></textarea>
                                        </div>

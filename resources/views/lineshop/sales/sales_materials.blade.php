                    ...
                    <div class="card">
                        <div class="card-block">
                            ...
                            <div class="col-lg-12 col-xl-12">
                                <div class="sub-title">Lineshop Important Materials</div>
                                <!-- Nav tabs -->
                                ...
                                <div class="tab-content tabs-left-content card-block">
                                    <div class="tab-pane active" id="home5" role="tabpanel">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                                <div class="badge-box">
                                                    <div class="sub-title">Lineshop Proposal
                                            ...
                                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                                <div class="badge-box">
                                                    <div class="sub-title">Lineshop Presentation
                                            ...
                                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                                <div class="badge-box">
                                                    <div class="sub-title">Lineshop Product Profile
                                            ...
                                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                                <div class="badge-box">
                                                    <div class="sub-title">Lineshop Brochure
                                    ...
                                    <div class="tab-pane" id="profile5" role="tabpanel">
                                        <div class="row">
                                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                                <div class="badge-box">
                                                    <div class="sub-title">Lineshop Agreement Form

                                                    </div>

                                                    <p>
                                                        Also called, Acceptance Form, provide this to customer interested to start using Lineshop
                                                    </p>
                                            ...
                                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                                <div class="badge-box">
                                                    <div class="sub-title">Lineshop NMB Application Form
                                            ...
                                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                                <div class="badge-box">
                                                    <div class="sub-title">Lineshop CRBD Application Form
                                            ...
                                            <div class="col-lg-4 col-xl-3 col-sm-6">
                                                <div class="badge-box">
                                                    ...
                                                    <p>
                                                        provide this to customer interested to start using Lineshop but needs a grace or trial period
                                                    </p>

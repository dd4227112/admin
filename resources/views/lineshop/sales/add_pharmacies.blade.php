...
<div class="page-header">
    ...
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">new pharmacy</a></li>
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xl-3 m-b-30">
                                <h4 class="sub-title">Pharmacy Name</h4>
                                <input name="name"  class="form-control" placeholder="Enter Pharmacy  Name.." autofocus required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-xl-3 m-b-30">
                                <h4 class="sub-title">Select Pharmacy Type</h4>
                            ...
                            <div class="col-sm-12 col-xl-3 m-b-30">
                                ...
                                <button type="submit" class="btn btn-primary btn-sm btn-round">Save</button>
                            </div>
                        </div>
                        <?= csrf_field() ?>
                    </form>

...
@section('content')
    ...
    <div class="page-header">
            <div class="page-header-title">
                <h4>Websites Pharmacy requests </h4>
            </div>
            <div class="page-header-breadcrumb">
                <ul class="breadcrumb-title">
                    ...
                    <li class="breadcrumb-item"><a href="#!">pharmacy</a>
                    </li>
                </ul>
            </div>
        </div> 
                                ...
                                <table id="example" class="table table-striped table-bordered nowrap dataTable">
                                    ...
                                    <tbody>
                                        <?php $i = 1;
                                            ...
                                            <tr>
                                                <td> <?= $i ?> </td>
                                                <td> <?= !empty($request->pharmacy_name) ? $request->pharmacy_name : '' ?></td>
                                                <td> <?= $request->contact_name ?></td> 
                                                <td> <?= $request->contact_phone ?></td> 
                                                <td> <?= $request->contact_email ?></td> 
                                                <td> 
                                                    <?php $view_url="lineshop/viewRequest/$request->id"; ?>
...
<script type="text/javascript">
    ...
    title: {
        text: 'Pharmacy Vs Months'
    },
    subtitle: {
        text: 'Overall Pharmacy onboarded'
    },
    xAxis: {
        type: 'Months',

        ...
        <div class="col-sm-8">
            <div class="card">
                <div class="card-block">
                    ...
                    <form class="form-horizontal" method="POST" action="<?= base_url('lineshop/communication') ?>"  enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select style="" id="form-field-select-0" class="select2" name="firstCriteria"
                                    ...
                                    <option value="00">Customers (Pharmacies with Active Accounts)</option>
                                    <option value="01">Prospects (all Pharmacies never signup for shulesoft)</option>
                                    <option value="02">Leads (all schools sign for shulesoft but not customers)</option>
                                    <option value="05">Churned pharmacies (All pharmacies once ware customers)</option>
                                    <option value="03">All customer contacts</option>
                        ...
                        <div class="form-group row" id="prospect_selection" style="display: none;">
                            ...
                            <div class="col-sm-8">
                                <select id="form-field-select-4" class="select2" name="prospectscriteria"
                                    ...
                                    <option value="002">Enter Phone number</option>
                                </select>
                            </div>
                            <div class="has-error">
                                <?php if (form_error($errors, 'criteria')): ?>
                        ...
                        <div class='form-group row'>
                            ...
                            <div class="col-sm-8">
                                ...
                                $templates = DB::table('admin.lineshoptemplates')->where('status', '1')->latest()->get();
...
<script>
    ...
    $('#sms_template').change(function () {
        ...
        $.ajax({
            ...
            url: "<?= base_url('lineshop/getTemplateContent') ?>",

                          ...
                          <div class="row">
                              <div class="col-lg-12 col-xl-12">
                                  ...
                                  <ul class="nav nav-tabs md-tabs " role="tablist">
                                      <li class="nav-item">
                                          <a class="nav-link active" data-toggle="tab" href="#home7" role="tab"><i class="icofont icofont-home"></i>REVENUE FORM</a>
                                          <div class="slide"></div>
                                      </li>
                                      <li class="nav-item">
                                          <a class="nav-link" data-toggle="tab" href="#profile7" role="tab"><i class="icofont icofont-ui-user "></i>UPLOAD EXCEL FILE</a>
                                          <div class="slide"></div>
                                      </li>
                                  </ul>
                                  <!-- Tab panes -->
                                                  ...
                                                  <div class="card-block">
                                                    <div class="row">
                                                        <div class="col-sm-12 col-xl-3">
                                                            <h4 class="sub-title">Payer name</h4>
                                      ...
                                      <div class="tab-pane" id="profile7" role="tabpanel">
                                          <div class="card">
                                            ...
                                            <img src="<?= url('public/images/sample_excel.jpg') ?>"/> --}}
                                              ...
                                              {{-- <p> <?= __("File") ?> <a href="<?= url('storage/uploads/sample/sample_students_upload.xlsx') ?>"><i class="fa fa-2x fa-cloud-download"></i></a></p> --}}

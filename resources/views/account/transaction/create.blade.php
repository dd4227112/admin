...
<div class="main-body">
    ...
    <div class="page-body">
        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                if (count($users)) {
                                    foreach ($users as $user) {
                                        $uarray[$user->id . ',' . $user->table] = $user->name . ' (' . $user->usertype . ')';
                                    }
                                }
                    ...
                    <div id="user_not_in_shulesoft_tag"  <?php request('user_in_shulesoft') == 2 ? '' : 'style="display: none;"' ?>>
                       <div class='form-group' >
                        <label for="amount" class="col-sm-2 control-label">
                            <?= __("payer_name") ?><span class="red">*</span>
                        </label>
                        <div class="col-sm-6">
                    ...
                    <div class='form-group' >
                    <label for="amount" class="col-sm-2 control-label">
                        <?= __("payer_phone") ?><span class="red">*</span>
                    </label>
                    <div class="col-sm-6">
                        ...
                        <input type="hidden" id="phone" name="payer_phone" >
                    </div>
                    <span class="col-sm-4 control-label">
        ...
        <label for="expense" class="col-sm-2 control-label">
            <?= __("fee_type") ?><span class="red">*</span>
        </label>
        <div class="col-sm-6">
            <?php
...
<?= csrf_field() ?>
        ...
        <h2>Add Revenue By Excel</h2>
        <p><?= __("file") ?> 
            <a href="<?= url('storage/uploads/sample/sample_students_upload.xlsx') ?>"><i class="fa fa-2x fa-cloud-download"></i></a></p>
        <form id="demo-form2" action="<?= url('revenue/uploadByFile') ?>" class="form-horizontal" method="POST"

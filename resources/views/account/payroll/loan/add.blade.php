...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-signal"></i> <?= __('panel_title') ?>-<?= __('loan_application') ?></h3>


        <ol class="breadcrumb">
            <li><a href="<?= url("dashboard/index") ?>"><i class="fa fa-laptop"></i> <?= __('menu_dashboard') ?></a></li>
            <li><a href="<?= url("loan/index") ?>"><?= __('loan_application') ?></a></li>
            <li class="active"><?= __('menu_add') ?> <?= __('loan_application') ?></li>
        </ol>
    </div><!-- /.box-header -->
    <div class="box-body">
        <span class="section"><?= __('menu_add') . ' ' . __('loan_application') ?>  </span> <p> <?= __('fields_marked') ?>  <span class="red">*</span> <?= __('are_mandatory') ?> </p>
        <div class="row">
            <div class="col-sm-8">

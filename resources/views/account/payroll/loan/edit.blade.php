...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-signal"></i> <?= __('panel_title') ?>-<?=__('deduction')?></h3>


        <ol class="breadcrumb">
            <li><a href="<?= url("dashboard/index") ?>"><i class="fa fa-laptop"></i> <?= __('menu_dashboard') ?></a></li>
            <li><a href="<?= url("grade/index") ?>"><?= __('deduction') ?></a></li>
    ...
    <div id="percentage_check" <?=$deduction->is_percentage==1 ?'':'style="display: none"'?>>
      ...
      <?php
        ...
        <div class="col-sm-6">
            ...
            <i class="fa fa-question-circle" data-container="body"
               data-toggle="popover" data-placement="top" data-trigger="hover"
               data-content="<?= __("Default Percentage") ?>"
               title="<?= __("Default Percentage") ?>"></i>
        </div>
        <span class="col-sm-4 control-label">
...
<h2>Optional Fields</h2>
  <div class="form-group">              
                ...
                <div class="col-sm-6">
                    ...
                    ?>
                </div><a><i class="fa fa-question-circle" data-container="body"
      data-toggle="popover" data-placement="top" data-trigger="hover"
      data-content=""
      title="Except under special condition, all deductions are taken from a basic salary"></i></a>
            </div>
            <div class="form-group">              
      ...
      data-toggle="popover" data-placement="top" data-trigger="hover"
      data-content="<?= __("summary") ?>"
      title="Write Government Control number if this is government related deduction"></i></a>
                    </div>
                    <span class="col-sm-4 control-label">

                                        ...
                                        <div class="x_content" id="print_div">
                                            ...
                                            <section class="content invoice invoice-header" >
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-sm-4 invoice-col">
                                                        <h1 class="pull-right invoice-title" style="font-size: 6rem; float: right; margin-left: 60%">Invoice</h1>
                                                    </div>
                                                    <!-- /.col -->
                                                </div>
                                                <!-- info row -->
                                                <div class="row invoice-info">
                                                    <div class="col-sm-4 invoice-col ">
                                                        ...
                                                        <address class="well-sm ">
                                                            ...
                                                            <br/>11th Block, Bima Road, Mikocheni B
                                                            <br/>Mobile no: +255 655 406 004
                                                            <br/>Telephone: +255 22 278 0228
                                                        </address>
                                                    </div>
                                                    <!-- /.col -->
                                                    <div class="col-sm-4 invoice-col">
                                                    ...
                                                    <div class="col-sm-4 invoice-col">
                                                        ...
                                                        <address>
                                                            ...
                                                            <br>
                                                            <b>Due Date:</b> <?= date('d M Y', strtotime($siteinfos->payment_deadline_date)) ?>
                                                            <br>
                                                        </address>
                                                    </div>
                                                    <!-- /.col -->

        ...
        <div class="col-md-12 col-xl-12">
          <div class="card">
            <div class="card-block tab-icon">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Invoice For &nbsp; &nbsp;  &nbsp;<span style="float: right;" class="btn btn-primary waves-effect" data-toggle="modal" data-target="#large-Modal">Define Due Date</span></h2>
                ...
                <div class="x_content" id="print_div">
                  ...
                  <section class="content invoice invoice-header" >
                    <!-- title row -->
                    <div class="row">
                      <div class="col-lg-4  col-sm-4 invoice-col">
                    ...
                    <div class="row invoice-info">
                      <div class="col-sm-4 invoice-col ">
                        <p class=" well-sm" style="font-size: 1rem">From</p>
                        <address class="well-sm ">
                        ...
                        <!-- /.col -->
                        <div class="col-sm-4 invoice-col">
                          <p class=" well-sm" style="font-size: 1rem;     padding: 9px 0;"> To</p>
                          <address>
                            <strong><?= $siteinfos->sname ?></strong>
                            <br><?= $siteinfos->address ?>
                            <br>Phone: <?= $siteinfos->phone ?>
                            <br>Email: <?= $siteinfos->email ?>
                          </address>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-4 invoice-col">
                          ...
                          <address>
                            ...
                            <br>
                            <b>Date:</b> <?= date('d M Y', strtotime($siteinfos->last_payment_date)); ?>
                            <br>
                            <b>Due Date:</b> <?= date('d M Y', strtotime($siteinfos->next_payment_date)) ?>
                            <br>
                          </address>
                        </div>
                        <!-- /.col -->

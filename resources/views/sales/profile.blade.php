                                                ...
                                                foreach ($contacts as $contact) {
                                                    ...
                                                    <div class="media m-b-10">
                                                        <a class="media-left" href="#!">
                                                            <img class="media-object img-circle" src="<?= $root ?><?=url('/')?>/public/assets/images/avatar-1.png" alt="Image">
                                                                ...
                                                                <div class="col-xs-10 col-sm-11 p-l-5 p-b-35">
                                                                    <div class="card m-0">
                                                                        ...
                                                                        <div class="card-block user-box">
                                                                            ...
                                                                            if (count($comments) > 0) {
                                                                                foreach ($comments as $comment) {
                                                                                    ...
                                                                                    <div class="media m-b-20">
                                                                                        <a class="media-left" href="#">
                                                                                            <img class="media-object img-circle m-r-20" src="<?= $root ?><?=url('/')?>/public/assets/images/avatar-1.png" alt="Image">
                                                                                        </a>
                                                                            ...
                                                                            <div class="media">
                                                                                <a class="media-left" href="#">
                                                                                    <img class="media-object img-circle m-r-20" src="<?= $root ?><?=url('/')?>/public/assets/images/avatar-blank.jpg" alt="Image">
                                                                                </a>
                                                                                <div class="media-body">
                                                                                    <form class="">
                                                                                        <div class="">
